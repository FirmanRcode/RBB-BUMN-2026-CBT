      ...
      <div className="max-w-5xl w-full z-10 animate-fade-in relative">
        ...
        <div className="mt-20 border-t border-dark-700/50 pt-8 flex flex-col items-center gap-6 animate-fade-in relative z-10 w-full max-w-4xl mx-auto pb-4">
          <div className="flex flex-wrap justify-center gap-6 md:gap-8 text-sm font-medium text-gray-400">
            ...
            <a href="https://wa.me/6282120605121" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-green-400 hover:scale-105 transition-all">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.891-4.443 9.893-9.892.001-5.45-4.436-9.89-9.89-9.891-5.452 0-9.887 4.441-9.889 9.891-.001 2.062.533 3.96 1.492 5.56l-1.082 3.95 4.084-1.21zm7.425-9.61c.21 0 .428-.01.63.1.2.1.472.235.635.438.164.203.355.602.355 1.137 0 .535-.205 1.138-.563 1.541-.358.403-.687.525-1.077.584-.39.059-1.026.014-1.554-.15-.528-.164-1.396-.51-2.28-1.22-.884-.711-1.745-1.74-2.145-2.288-.399-.548-.822-1.346-.822-2.146 0-.8.368-1.21.572-1.44.205-.23.472-.37.74-.37.268 0 .445.03.627.03.181 0 .285.01.441.37.157.36.543 1.35.611 1.49.068.14.212.31.25.46.037.15.111.45-.102.82-.213.37-.306.49-.452.68-.146.19-.344.42-.486.53-.142.11-.274.22-.116.51.157.29.704 1.18 1.503 1.9 1.031.93 1.905 1.22 2.19 1.35.285.13.483.11.666-.08.183-.19.789-.92 1.004-1.24.215-.32.413-.26.697-.16z"/></svg>
              +62 821-2060-5121
            </a>
